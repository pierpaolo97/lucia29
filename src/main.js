    ...
    app.innerHTML = `
      <main class="intro">
        ...
        <div class="intro-card">
          ...
          <p>
            Solo dopo potrai sbloccare il regalo 🎁
          </p>
    ...
    if (collected === totalItems) {
      ...
      app.innerHTML = `
        <main class="final">
          ...
          <p>
            Incredibile davvero opo 29 anni sei riuscita da sola
            ad arrivare fin qui con il tuo telefono.
          </p>

          <p>
            Senza chiedere l'aiuto di nessuno, hai raccolto tutti gli oggetti e sbloccato il regalo.
    ...
    if (collected === totalItems) {
      app.innerHTML = `
        <main class="final">
          ...
          <p>
            Incredibile dabbero opo 29 anni sei riuscita ad usare
            ad arrivare fin qui con il tuo telefono da sola.
          </p>
